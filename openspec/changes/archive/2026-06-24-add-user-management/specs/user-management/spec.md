...
> en el delta de `access-control` como `## MODIFIED Requirements` sobre la requirement de F2
> *"Asignación de perfil a usuario"*, extendida con sincronización de `role` + blacklist. Se evita
> duplicar la misma regla en dos capabilities (DRY/KISS).
