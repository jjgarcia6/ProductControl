# Delta para system-settings

<!-- Keywords Gherkin en español (DADO/CUANDO/ENTONCES/Y); keywords RFC 2119 en inglés. -->
<!-- Este delta INICIA la capability `system-settings`: singleton de parámetros globales -->
<!-- con los dos toggles de costeo. F8 solo almacena y protege los flags. -->
