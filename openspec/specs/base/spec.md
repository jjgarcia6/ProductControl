...
Infraestructura visual del frontend (design system / shadcn). Define el contrato de tokens
del theme, su mapeo a la paleta de `config.yaml`, el enfoque CSS-first de Tailwind v4 y las
dependencias del stack de UI. No hay endpoints DRF ni actores de dominio; los requisitos
verifican el sistema visual y el build.
